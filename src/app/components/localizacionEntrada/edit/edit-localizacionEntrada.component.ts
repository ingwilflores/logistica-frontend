...
@Component({
  selector: "app-edit-localizacionEntrada",
  templateUrl: "./edit-localizacionEntrada.component.html",
  styleUrls: ["./edit-localizacionEntrada.component.css"]
})
export class EditLocalizacionEntradaComponent implements OnInit {
  data: {[k: string]: any} = {};
